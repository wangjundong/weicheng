...
<div class="page-header">
	当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?><?php  if($type==0) { ?>购物<?php  } else if($type==1) { ?>充值<?php  } else if($type==2) { ?>收银台<?php  } ?>优惠券 <small><?php  if(!empty($item['id'])) { ?>修改【<?php  echo $item['couponname'];?>】<?php  } ?></small></span>
