...
<div class="form-group">
    <label class="col-lg control-label">是否开启口令玩法</label>
	...
	<div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">开始活动关键词</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
 	 ...
 	 <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">口令集</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
	     ...
	     <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">每人猜测机会</label>
                <div class="col-sm-9 col-xs-12">
                     <?php if( ce('sale.coupon' ,$item) ) { ?>
	     ...
	     <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">提示语</label>
                <div class="col-sm-9 col-xs-12">
                     <?php if( ce('sale.coupon' ,$item) ) { ?>
	   ...
	   <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">猜中提示语</label>
                <div class="col-sm-9 col-xs-12">
                     <?php if( ce('sale.coupon' ,$item) ) { ?>
	  ...
	  <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">猜错提示语</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
	   ...
	   <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">猜测次数超出限制提示</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
	     ...
	     <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">退出口令</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
		  ...
		  <span class="help-block">如果设置有次数限制，用户继续猜了，可输入退出口令，默认为0</span>
		   ...
		   <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">退出后提示</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
	  ...
	  <div class="form-group couponkey" <?php  if(empty($item['pwdopen'])) { ?>style="display:none"<?php  } ?>>
                <label class="col-lg control-label">已获得提示</label>
                <div class="col-sm-9 col-xs-12">
                    <?php if( ce('sale.coupon' ,$item) ) { ?>
