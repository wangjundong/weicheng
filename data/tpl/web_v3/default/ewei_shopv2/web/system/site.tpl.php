...
<div class="page-header">
    当前位置：<span class="text-primary">网站设置</span>
</div>
...
<div class="page-content">
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('system.site' ,$data) ) { ?>
                    <label class='radio-inline'><input type='radio' name='data[status]' value='1' <?php  if($data['status']==1) { ?>checked<?php  } ?> /> 开启</label>
                    <label class='radio-inline'><input type='radio' name='data[status]' value='0' <?php  if($data['status']==0) { ?>checked<?php  } ?> /> 关闭</label>
                <?php  } else { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站入口</label>
            <div class="col-sm-9 col-xs-12">
                <p class='form-control-static'><a href='javascript:;' class="js-clip" title='点击复制连接' data-url="<?php  echo $_SERVER['SERVER_NAME'].'/pcsite/'?>" ><?php  echo $_SERVER['SERVER_NAME'].'/pcsite/'?></a></p>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">网站模板选择</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站关闭后跳转的连接</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站名称</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站LOGO</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">微信二维码</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                    <?php  echo tpl_form_field_image2('data[qrcode]', $data['qrcode'])?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站关键词</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">网站简介</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">首页案例展示副标题</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                    <textarea name="data[casesubtitle]" class="form-control richtext" rows="5"><?php  echo $data['casesubtitle'];?></textarea>
                <?php  } else { ?>
                    <textarea name="data[casesubtitle]" class="form-control richtext" rows="5" style="display:none"><?php  echo $data['casesubtitle'];?></textarea>
                    <div class='form-control-static'><?php  echo $data['casesubtitle'];?></div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">首页新闻动态副标题</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                    <textarea name="data[newsubtitle]" class="form-control richtext" rows="5"><?php  echo $data['newsubtitle'];?></textarea>
                <?php  } else { ?>
                    <textarea name="data[newsubtitle]" class="form-control richtext" rows="5" style="display:none"><?php  echo $data['newsubtitle'];?></textarea>
                    <div class='form-control-static'><?php  echo $data['newsubtitle'];?></div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">首页最新文章副标题</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                    <textarea name="data[articlesubtitle]" class="form-control richtext" rows="5"><?php  echo $data['articlesubtitle'];?></textarea>
                <?php  } else { ?>
                    <textarea name="data[articlesubtitle]" class="form-control richtext" rows="5" style="display:none"><?php  echo $data['articlesubtitle'];?></textarea>
                    <div class='form-control-static'><?php  echo $data['articlesubtitle'];?></div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">首页友情链接副标题</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                    <textarea name="data[linksubtitle]" class="form-control richtext" rows="5"><?php  echo $data['linksubtitle'];?></textarea>
                <?php  } else { ?>
                    <textarea name="data[linksubtitle]" class="form-control richtext" rows="5" style="display:none"><?php  echo $data['linksubtitle'];?></textarea>
                    <div class='form-control-static'><?php  echo $data['linksubtitle'];?></div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">首页联系我们副标题</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
                <textarea name="data[contactsubtitle]" class="form-control richtext" rows="5"><?php  echo $data['contactsubtitle'];?></textarea>
                <?php  } else { ?>
                <textarea name="data[contactsubtitle]" class="form-control richtext" rows="5"style="display:none"><?php  echo $data['contactsubtitle'];?></textarea>
        ...
        <div class="form-group">
            <label class="col-lg control-label">联系人</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">联系方式</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">客服QQ</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
        ...
        <div class="form-group">
            <label class="col-lg control-label">联系地址</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('system.site')) { ?>
