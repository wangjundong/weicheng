<?php defined('IN_IA') or exit('Access Denied');?><style>
    ...
    .live-menu-ul li a.add{background: #44abf7  ;color:#fff;border:none;line-height: 35px;}
    .live-menu-ul li.active a{background: #fff;border:1px solid #44abf7  ;}
            ...
            <div class="phone-main" id="phone">
                ...
                <div>
                    <div class="block-tab" id="sortable">
                        <?php  if(is_array($nestables)) { foreach($nestables as $index => $row) { ?>
                        <a href="javascript:void(0);" data-tab="<?php  echo $row;?>" style="<?php  if(($menu['goods']['isshow']==1 && $row=='goods')||($menu['introduce']['isshow']==1 && $row=='introduce')) { ?>display: none;<?php  } else { ?>display: block;<?php  } ?>" class="nestable-list <?php  echo $row;?> <?php  if($index==0) { ?>active<?php  } ?>">
                            <input type="hidden" name="nestable[]" value="<?php  echo $row;?>">
                            ...
                            <?php  } ?>
                            <?php  if($row!='interaction' && $row!='goods' && $row!='introduce' ) { ?>
    ...
    <div class="flex column">
        <div class="diy-top-menu">
            <ul class="live-menu-ul">
                ...
                <li style="<?php  if(empty($menu['goods']['isshow'])) { ?>display:none;<?php  } else { ?>display:block;<?php  } ?>"><a href="javascript:void(0);" data-tab="goods" class="nestable-list goods">商品</a></li>
                <li style="<?php  if(empty($menu['introduce']['isshow'])) { ?>display:none;<?php  } else { ?>display:block;<?php  } ?>"><a href="javascript:void(0);" data-tab="introduce" class="nestable-list introduce">介绍</a></li>
            </ul>
        </div>
        <div class="diy-editor">
            ...
            <div class="diy-editor-group" id="editor">
                <!--互动start-->
                <div class="inner live-menu-interaction" style="<?php  if($nestables['0']=='interaction') { ?>display: block;<?php  } ?>">
                ...
                <!--互动end-->
                <!--商品satart-->
                <div class="inner live-menu-goods" style="<?php  if($nestables['0']=='goods') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-addon">
                                    <input type="checkbox" name="dtab[goodstitleshow]" <?php  if(empty($menu['goods']['isshow'])) { ?>checked<?php  } ?> class="" value="<?php  if(empty($menu['goods']['isshow'])) { ?>0<?php  } else { ?>1<?php  } ?>" >  显示
                                </div>
                                <?php  } else { ?>
                ...
                <!--商品end-->
                <!--直播间介绍start-->
                <div class="inner live-menu-introduce" style="<?php  if($nestables['0']=='introduce') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-addon">
                                    <input type="checkbox" name="dtab[introducetitleshow]" <?php  if(empty($menu['introduce']['isshow'])) { ?>checked<?php  } ?> class="" value="<?php  if(empty($menu['introduce']['isshow'])) { ?>0<?php  } else { ?>1<?php  } ?>" >  显示
                                </div>
                                <?php  } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-xs-12">
                            ...
                            <?php  } else { ?>
                            <textarea id='detail' style='display:none'><?php  echo $item['introduce'];?></textarea>
                ...
                <!--直播间介绍end-->
                <!--自定义菜单1start-->
                <div class="inner live-menu-customname1" style="<?php  if($nestables['0']=='customname1') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customname1]" data-tab="customname1" class="live-name form-control" value="<?php  if(!empty($menu['customname1']['name'])) { ?><?php  echo $menu['customname1']['name'];?><?php  } else { ?>自定义<?php  } ?>"  />
                                <?php  } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype1]' data-tab="customname1" value="0" <?php  if(empty($menu['customname1']['type'])) { ?>checked<?php  } ?> /> 文本</label>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype1]' data-tab="customname1" value="1" <?php  if($menu['customname1']['type']==1) { ?>checked<?php  } ?> /> 链接</label>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  if(empty($menu['customname1']['type'])) { ?>文本<?php  } else if($menu['customname1']['type']==1) { ?>链接<?php  } ?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname1-type-url" style="<?php  if($menu['customname1']['type']==1) { ?>display: block;<?php  } else { ?>display:none;<?php  } ?>">
                        <label class="col-sm-2 control-label">链接</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customurl1]" class="form-control input-sm diy-bind" placeholder="请选择链接或输入链接地址" value="<?php  echo $menu['customname1']['url'];?>" id="shareurl" />
                                <span data-input="#shareurl" data-toggle="selectUrl" data-full="true" class="input-group-addon btn btn-default">选择链接</span>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  echo $menu['customname1']['url'];?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname1-type-content" style="<?php  if(empty($menu['customname1']['type'])) { ?>display:block;<?php  } else { ?>display:none;<?php  } ?>">
                ...
                <!--自定义菜单1end-->
                <!--自定义菜单2start-->
                <div class="inner live-menu-customname2" style="<?php  if($nestables['0']=='customname2') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customname2]" data-tab="customname2" class="live-name form-control" value="<?php  if(!empty($menu['customname2']['name'])) { ?><?php  echo $menu['customname2']['name'];?><?php  } else { ?>自定义<?php  } ?>"  />
                                <?php  } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype2]' data-tab="customname2" value="0" <?php  if(empty($menu['customname2']['type'])) { ?>checked<?php  } ?> /> 文本</label>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype2]' data-tab="customname2" value="1" <?php  if($menu['customname2']['type']==1) { ?>checked<?php  } ?> /> 链接</label>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  if(empty($menu['customname2']['type'])) { ?>文本<?php  } else if($menu['customname2']['type']==1) { ?>链接<?php  } ?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname2-type-url" style="<?php  if($menu['customname2']['type']==1) { ?>display: block;<?php  } else { ?>display:none;<?php  } ?>">
                        <label class="col-sm-2 control-label">链接</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customurl2]" class="form-control input-sm diy-bind" placeholder="请选择链接或输入链接地址" value="<?php  echo $menu['customname2']['url'];?>" id="shareurl2" />
                                <span data-input="#shareurl2" data-toggle="selectUrl" data-full="true" class="input-group-addon btn btn-default">选择链接</span>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  echo $menu['customname2']['url'];?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname2-type-content" style="<?php  if($menu['customname2']['type']==1) { ?>display: none;<?php  } else { ?>display:block;<?php  } ?>">
                        <label class="col-sm-2 control-label">内容</label>
                        <div class="col-sm-10 col-xs-12">
                            <?php if( ce('live.room' ,$item) ) { ?>
                ...
                <!--自定义菜单2end-->
                <!--自定义菜单3start-->
                <div class="inner live-menu-customname3" style="<?php  if($nestables['0']=='customname3') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customname3]" data-tab="customname3" class="live-name form-control" value="<?php  if(!empty($menu['customname3']['name'])) { ?><?php  echo $menu['customname3']['name'];?><?php  } else { ?>自定义<?php  } ?>"  />
                                <?php  } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype3]' data-tab="customname3" value="0" <?php  if(empty($menu['customname3']['type'])) { ?>checked<?php  } ?> /> 文本</label>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype3]' data-tab="customname3" value="1" <?php  if($menu['customname3']['type']==1) { ?>checked<?php  } ?> /> 链接</label>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  if(empty($menu['customname3']['type'])) { ?>文本<?php  } else if($menu['customname3']['type']==1) { ?>链接<?php  } ?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname3-type-url" style="<?php  if($menu['customname3']['type']==1) { ?>display: block;<?php  } else { ?>display:none;<?php  } ?>">
                        <label class="col-sm-2 control-label">链接</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customurl3]" class="form-control input-sm diy-bind" placeholder="请选择链接或输入链接地址" value="<?php  echo $menu['customname3']['url'];?>" id="shareurl3" />
                                <span data-input="#shareurl3" data-toggle="selectUrl" data-full="true" class="input-group-addon btn btn-default">选择链接</span>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  echo $menu['customname3']['url'];?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname3-type-content" style="<?php  if($menu['customname3']['type']==1) { ?>display: none;<?php  } else { ?>display:block;<?php  } ?>">
                        <label class="col-sm-2 control-label">内容</label>
                        <div class="col-sm-10 col-xs-12">
                            <?php if( ce('live.room' ,$item) ) { ?>
                ...
                <!--自定义菜单3end-->
                <!--自定义菜单4start-->
                <div class="inner live-menu-customname4" style="<?php  if($nestables['0']=='customname4') { ?>display: block;<?php  } ?>">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">名称</label>
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customname4]" data-tab="customname4" class="live-name form-control" value="<?php  if(!empty($menu['customname4']['name'])) { ?><?php  echo $menu['customname4']['name'];?><?php  } else { ?>自定义<?php  } ?>"  />
                                <?php  } else { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype4]' data-tab="customname4" value="0" <?php  if(empty($menu['customname4']['type'])) { ?>checked<?php  } ?> /> 文本</label>
                                <label class="radio-inline"><input type="radio" class="customname" name='dtab[customtype4]' data-tab="customname4" value="1" <?php  if($menu['customname4']['type']==1) { ?>checked<?php  } ?> /> 链接</label>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  if(empty($menu['customname4']['type'])) { ?>文本<?php  } else if($menu['customname4']['type']==1) { ?>链接<?php  } ?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname4-type-url" style="<?php  if($menu['customname4']['type']==1) { ?>display: block;<?php  } else { ?>display:none;<?php  } ?>">
                        <label class="col-sm-2 control-label">链接</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-sm">
                                <?php if( ce('live.room' ,$item) ) { ?>
                                <input type="text" name="dtab[customurl4]" class="form-control input-sm diy-bind" placeholder="请选择链接或输入链接地址" value="<?php  echo $menu['customname4']['url'];?>" id="shareurl4" />
                                <span data-input="#shareurl4" data-toggle="selectUrl" data-full="true" class="input-group-addon btn btn-default">选择链接</span>
                                <?php  } else { ?>
                                <div class='form-control-static'><?php  echo $menu['customname4']['url'];?></div>
                                <?php  } ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group customname4-type-content" style="<?php  if($menu['customname3']['type']==1) { ?>display: none;<?php  } else { ?>display:block;<?php  } ?>">
                        <label class="col-sm-2 control-label">内容</label>
                        <div class="col-sm-10 col-xs-12">
                            <?php if( ce('live.room' ,$item) ) { ?>
    ...
    require(['jquery.ui'],function(){
        $(function () {
            ...
            $(".menu-add").off("click").on("click",function (event) {
                ...
                var nestable = "";
                var id = parseInt(<?php  echo $_GPC['id'];?>);
