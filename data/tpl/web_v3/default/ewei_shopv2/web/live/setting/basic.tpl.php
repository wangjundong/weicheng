<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
	<label class="col-lg control-label">会员中心显示</label>
...
<div class="form-group">
	...
	<div class="col-sm-9 col-xs-12">
		<?php if(cv('live.setting.edit')) { ?>
		<textarea style="height:100px;" rows="5" name="data[share_desc]" class="form-control" cols="60"><?php  echo $data['share_desc'];?></textarea>
		<?php  } else { ?>
		<textarea style="height:100px;display: none" rows="5" name="data[share_desc]" class="form-control" cols="60"><?php  echo $data['share_desc'];?></textarea>
