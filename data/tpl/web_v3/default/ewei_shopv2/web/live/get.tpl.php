<?php defined('IN_IA') or exit('Access Denied');?><div class="content_hasoption">
    ...
    <!--<div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <?php  if(is_array($list)) { foreach($list as $key => $val) { ?>
                <label class="radio-inline"><input type="radio" name="type" value="<?php  echo $key;?>"> <?php  echo $val;?></label>
            <?php  } } ?>
        </div>
    </div>-->
