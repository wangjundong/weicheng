...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_express` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=95 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6748 ;
...
(44, 47, 'app', '小程序', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/app.jpg', '', 0, 0, 1),
(45, 48, 'invitation', '邀请卡', '1.0', '官方', 1, 'sale', '../addons/ewei_shopv2/static/images/invitation.png', '', 0, 0, 1);
