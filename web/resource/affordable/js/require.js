...
try{if(window.console&&window.console.log){console.log("weichengtech")}}catch(e){};define('jquery', [], function() {return jQuery;});define('bootstrap', [], function() {if (typeof jQuery.fn.modal == 'undefined') {var $ = require(['../lib/bootstrap.min']);return jQuery;}return jQuery;});
require.config({
